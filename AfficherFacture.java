...
public class AfficherFacture implements Initializable {
    ...
    @FXML
    private TextField tf_rechercher_Facture;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        num_facture.setCellValueFactory(new PropertyValueFactory<>("Numéro de Facture"));
...
//           
    ...
    private void editerFacture(ActionEvent event) throws IOException {
        ...
        try {
            ...
            EditFacture editf = (EditFacture) loader.getController();
    ...
    private void rechercherFacture() {
        System.out.println("");
        try {
            Factures = new FactureService().search(tf_rechercher_Facture.getText());
            listFacture.clear();
            table_Facture.getItems().setAll(Factures);
